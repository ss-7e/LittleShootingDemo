...
{
    public GameObject EnemyPrefab;      // 目前只有一种敌人,直接配置
    ...
    private void SpawnEnemyUnit()
    {
        ...
        GameObject e = Instantiate(EnemyPrefab, position + PlayerTransform.position, Quaternion.identity, parent.transform);
